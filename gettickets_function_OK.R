...
library(plyr)
  ...
  setwd(paste("D:/KEEP_ISKAR/R/datos/herramientas/TICKETS/TICKETS", year,"/datos/", tienda, sep =""))
...
print(cajeros)
  ...
  setwd(paste("D:/KEEP_ISKAR/R/datos/herramientas/TICKETS/TICKETS", year,"/reportes", sep =""))
